document.getElementById('generation').addEventListener('click', function() { // Метод для кнопки "Генерация"; 
...
document.getElementById('clear').addEventListener('click', function() { // Метод для кнопки "Очистить"; 
